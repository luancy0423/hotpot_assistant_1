...
create_ui 仍在此文件；逻辑已拆至 frontend/* 与 config，此处保留完整 UI 与 CSS 以便直接运行。
"""
...
# 加载 .env（与 app.py 一致；也可由 app.py 先调用 config.load_dotenv）
try:
...
/* ── 步骤2：偏好选择卡片 ───────────────────────────────── */
#page-step1 { background: transparent; min-height: 60vh; }
.pref-acc {
...
/* ── 步骤3：方案结果 ────────────────────────────────────── */
#page-step2 { background: transparent; }
#plan-scroll-wrap {
